...
You can reply to me at: ${email || "..."}.`;
  ...
  return (
    <section id="contact" className="bg-[var(--brand-dark)] text-white px-4 py-16 sm:px-6 sm:py-20">
      <div className="mx-auto max-w-4xl">
        <p className="mb-3 text-sm font-semibold uppercase tracking-[0.2em] text-[var(--brand-mint)]">
          Start your project
        </p>
        <h2 className="mb-2 text-3xl font-bold sm:text-4xl">Tell me what you need.</h2>
        ...
        <div className="grid gap-8 md:grid-cols-[minmax(0,2fr)_minmax(0,1.2fr)]">
          ...
          >
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-white/10 bg-transparent px-3 py-2 text-sm text-white placeholder:text-white/40 focus:border-[var(--brand-mint)] focus:outline-none"
            ...
            <div>
              ...
              <select
                ...
                className="w-full rounded-lg border border-white/10 bg-[var(--brand-dark)] px-3 py-2 text-sm text-white focus:border-[var(--brand-mint)] focus:outline-none"
              >
            ...
            <div>
              ...
              <textarea
                ...
                className="min-h-[120px] w-full rounded-lg border border-white/10 bg-transparent px-3 py-2 text-sm text-white placeholder:text-white/40 focus:border-[var(--brand-mint)] focus:outline-none"
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <a
                ...
                className="inline-flex flex-1 items-center justify-center gap-2 rounded-full bg-[var(--brand-mint)] px-6 py-3 text-sm font-semibold text-[var(--brand-dark)] shadow-lg shadow-[var(--brand-mint)]/25 transition hover:scale-[1.02] hover:bg-[var(--brand-green)] hover:shadow-[var(--brand-mint)]/40"
              >
                Send on WhatsApp
              </a>
              <a
                href={mailtoUrl}
                className="inline-flex flex-1 items-center justify-center gap-2 rounded-full border border-[var(--brand-mint)] px-6 py-3 text-sm font-semibold text-white transition hover:bg-[var(--brand-mint)] hover:text-[var(--brand-dark)]"
              >
                Send as email
              </a>
            </div>
            <p className="text-xs text-white/50">
              I usually reply within a few hours. For urgent projects, WhatsApp is faster.
            </p>
          </form>
          ...
          <div className="space-y-4 rounded-2xl border border-white/10 bg-white/5 p-6 text-sm text-white/80">
            ...
            <div className="mt-4 rounded-xl bg-black/20 p-4">
              <p className="text-xs uppercase tracking-[0.18em] text-[var(--brand-mint)]">
                Preferred contact
              </p>
              <p className="mt-1 text-sm">
                <span className="font-semibold text-white">WhatsApp</span> for fast back-and-forth,
                <br />
                <span className="font-semibold text-white">Email</span> for detailed project briefs.
              </p>
            </div>
          </div>
        </div>
